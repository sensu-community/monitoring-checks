...
api_version: core/v2
metadata:
  name: check-whois-domain-expiration-multi
  namespace: default
spec:
  command: check-whois-domain-expiration-multi.rb -d {{ .labels.check_whois_domain_expiration_multi_domains | default "google.com,bing.com" }}
  interval: 3600
  publish: true
  runtime_assets:
