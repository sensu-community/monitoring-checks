...
api_version: core/v2
metadata:
  name: check-jsonwhois-domain-expiration
  namespace: default
spec:
  command: check-jsonwhois-domain-expiration.rb -a {{ .labels.check_jsonwhois_domain_expiration_apikey }} -d foo.com,bar.com
  interval: 3600
  publish: true
  runtime_assets:
